  ...
  return (
    ...
    {/* <h2 className="text-4xl font-bold mb-4">About Me</h2> */}
      <p className="text-lg mb-4">
        Hello! I am  <span className='text-blue-300'>Muhammad Abdullah</span>, a passionate web developer based in Pakistan. With almost a year of experience in the web development field, I have honed my skills through self-learning and hands-on projects. I am currently studying at PIAIC (Presidential Initiative for Artificial Intelligence & Computing), a prestigious program dedicated to nurturing the next generation of tech professionals.
      </p>
      ...
      <p className="text-md mb-4">
        As a developer, I strive to create impactful and efficient web applications that meet the needs of my clients. Whether it is building dynamic websites, optimizing user experiences, or integrating advanced AI functionalities, I am committed to delivering top-notch solutions.
      </p>
      ...
      <p className="text-sm mb-4">
        If you are looking for a dedicated and innovative web developer who is ready to take on exciting challenges, let&apos;s connect and bring your ideas to life!
      </p>
    </div>
  </div>
